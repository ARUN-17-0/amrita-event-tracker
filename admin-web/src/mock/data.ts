...
export const mockEvents: AcademicEvent[] = [
  { id: 'evt-001', title: 'DSA Periodical 1', type: 'exam', description: 'Periodical 1 for Data Structures', subjectId: 'sub-001', sectionId: 'sec-001', semesterId: 'sem-003', eventDate: addDays(now, 2), eventTime: '09:00', createdBy: 'fac-001', createdAt: subDays(now, 5), updatedAt: subDays(now, 5), isActive: true },
  { id: 'evt-002', title: 'DBMS Assignment 1', type: 'assignment', description: 'SQL Queries Assignment', subjectId: 'sub-002', sectionId: 'sec-001', semesterId: 'sem-003', eventDate: addDays(now, 5), eventTime: '23:59', createdBy: 'fac-002', createdAt: subDays(now, 2), updatedAt: subDays(now, 2), isActive: true },
  { id: 'evt-003', title: 'CN Quiz', type: 'quiz', description: 'Networking Basics Quiz', subjectId: 'sub-003', sectionId: 'sec-002', semesterId: 'sem-003', eventDate: now, eventTime: '14:00', createdBy: 'fac-001', createdAt: subDays(now, 3), updatedAt: subDays(now, 3), isActive: true },
  { id: 'evt-004', title: 'OS Lab Evaluation', type: 'lab', description: 'Process Scheduling Lab Eval', subjectId: 'sub-004', sectionId: 'sec-001', semesterId: 'sem-003', eventDate: subDays(now, 1), eventTime: '10:00', createdBy: 'fac-002', createdAt: subDays(now, 7), updatedAt: subDays(now, 7), isActive: true },
  { id: 'evt-005', title: 'DSP Project Review', type: 'project', description: 'First review for DSP project', subjectId: 'sub-005', sectionId: 'sec-004', semesterId: 'sem-003', eventDate: addDays(now, 10), eventTime: '15:00', createdBy: 'fac-003', createdAt: subDays(now, 1), updatedAt: subDays(now, 1), isActive: true },
  { id: 'evt-006', title: 'Microprocessors Exam', type: 'exam', description: 'Mid-term exam', subjectId: 'sub-006', sectionId: 'sec-004', semesterId: 'sem-003', eventDate: addDays(now, 15), eventTime: '09:30', createdBy: 'fac-003', createdAt: subDays(now, 1), updatedAt: subDays(now, 1), isActive: true },
  { id: 'evt-007', title: 'Control Systems Assignment', type: 'assignment', description: 'Root Locus Assignment', subjectId: 'sub-007', sectionId: 'sec-006', semesterId: 'sem-003', eventDate: addDays(now, 7), eventTime: '23:59', createdBy: 'fac-004', createdAt: subDays(now, 2), updatedAt: subDays(now, 2), isActive: true },
  { id: 'evt-008', title: 'Power Electronics Lab', type: 'lab', description: 'Inverter Lab', subjectId: 'sub-008', sectionId: 'sec-006', semesterId: 'sem-003', eventDate: addDays(now, 4), eventTime: '11:00', createdBy: 'fac-004', createdAt: subDays(now, 2), updatedAt: subDays(now, 2), isActive: true },
  { id: 'evt-009', title: 'Thermodynamics Quiz', type: 'quiz', description: 'First Law Quiz', subjectId: 'sub-009', sectionId: 'sec-007', semesterId: 'sem-003', eventDate: addDays(now, 1), eventTime: '10:00', createdBy: 'fac-005', createdAt: subDays(now, 3), updatedAt: subDays(now, 3), isActive: true },
  { id: 'evt-010', title: 'Fluid Mechanics Exam', type: 'exam', description: 'Periodical 1', subjectId: 'sub-010', sectionId: 'sec-008', semesterId: 'sem-003', eventDate: addDays(now, 6), eventTime: '09:00', createdBy: 'fac-006', createdAt: subDays(now, 4), updatedAt: subDays(now, 4), isActive: true }
];
