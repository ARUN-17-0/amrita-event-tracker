...
async function seed() {
  ...
  const subjects = [
    { id: "sub-001", name: "Data Structures and Algorithms", code: "21CS301", departmentId: "dept-001", semesterId: "sem-003", semesterNumber: 3, semesterType: "odd", credits: 4 },
    { id: "sub-002", name: "Database Management Systems",   code: "21CS302", departmentId: "dept-001", semesterId: "sem-003", semesterNumber: 3, semesterType: "odd", credits: 4 },
    { id: "sub-003", name: "Operating Systems",             code: "21CS303", departmentId: "dept-001", semesterId: "sem-003", semesterNumber: 4, semesterType: "even", credits: 3 },
    { id: "sub-004", name: "Digital Signal Processing",     code: "21EC301", departmentId: "dept-002", semesterId: "sem-003", semesterNumber: 5, semesterType: "odd", credits: 4 },
    { id: "sub-005", name: "VLSI Design",                   code: "21EC302", departmentId: "dept-002", semesterId: "sem-003", semesterNumber: 6, semesterType: "even", credits: 3 },
    { id: "sub-006", name: "Power Systems",                 code: "21EE301", departmentId: "dept-003", semesterId: "sem-003", semesterNumber: 5, semesterType: "odd", credits: 4 },
    { id: "sub-007", name: "Thermodynamics",                code: "21ME301", departmentId: "dept-004", semesterId: "sem-003", semesterNumber: 3, semesterType: "odd", credits: 4 },
    { id: "sub-008", name: "Structural Analysis",           code: "21CE301", departmentId: "dept-005", semesterId: "sem-003", semesterNumber: 5, semesterType: "odd", credits: 4 },
  ];
  batch = writeBatch(db);
