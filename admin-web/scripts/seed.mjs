...
async function seed() {
  ...
  const sems = [
    { id: "sem-001", name: "Odd Semester 2023",  year: "2023", isCurrent: false, isActive: false, startDate: Timestamp.fromDate(new Date("2023-08-01")), endDate: Timestamp.fromDate(new Date("2023-12-31")) },
    { id: "sem-002", name: "Even Semester 2024", year: "2024", isCurrent: false, isActive: false, startDate: Timestamp.fromDate(new Date("2024-01-15")), endDate: Timestamp.fromDate(new Date("2024-05-31")) },
    { id: "sem-003", name: "Odd Semester 2024",  year: "2024", isCurrent: true,  isActive: true,  startDate: Timestamp.fromDate(new Date("2024-08-01")), endDate: Timestamp.fromDate(new Date("2024-12-31")) },
    { id: "sem-004", name: "Even Semester 2025", year: "2025", isCurrent: false, isActive: true,  startDate: Timestamp.fromDate(new Date("2025-01-15")), endDate: Timestamp.fromDate(new Date("2025-05-31")) },
  ];
  batch = writeBatch(db);
  sems.forEach(s => batch.set(doc(db, "semesters", s.id), { ...s, createdAt: serverTimestamp(), updatedAt: serverTimestamp() }));
  await batch.commit();
  console.log("Semesters written");
  ...
  const subjects = [
    { id: "sub-001", name: "Data Structures and Algorithms", code: "21CS301", departmentId: "dept-001", semesterId: "sem-003", credits: 4 },
    { id: "sub-002", name: "Database Management Systems",   code: "21CS302", departmentId: "dept-001", semesterId: "sem-003", credits: 4 },
    { id: "sub-003", name: "Operating Systems",             code: "21CS303", departmentId: "dept-001", semesterId: "sem-003", credits: 3 },
    { id: "sub-004", name: "Digital Signal Processing",     code: "21EC301", departmentId: "dept-002", semesterId: "sem-003", credits: 4 },
    { id: "sub-005", name: "VLSI Design",                   code: "21EC302", departmentId: "dept-002", semesterId: "sem-003", credits: 3 },
    { id: "sub-006", name: "Power Systems",                 code: "21EE301", departmentId: "dept-003", semesterId: "sem-003", credits: 4 },
    { id: "sub-007", name: "Thermodynamics",                code: "21ME301", departmentId: "dept-004", semesterId: "sem-003", credits: 4 },
    { id: "sub-008", name: "Structural Analysis",           code: "21CE301", departmentId: "dept-005", semesterId: "sem-003", credits: 4 },
  ];
  batch = writeBatch(db);
